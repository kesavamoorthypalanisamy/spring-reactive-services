...
import com.hippo.userservice.models.TrasactionRequestDto;
import com.hippo.userservice.models.TrasactionResponseDto;
...
public class EntityMapperUtil {
    ...
    public static UserTransaction toTransactionEntity(TrasactionRequestDto dto) {
    ...
    public static TrasactionResponseDto toTrasactionResponseDto(TrasactionRequestDto userTransaction,
            TrasactionStatus status) {
        TrasactionResponseDto trasactionResponseDto = new TrasactionResponseDto();
